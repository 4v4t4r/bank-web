...
# WHITE TEAM ACCOUNT
define('WHITE_TEAM_ACCOUNT', '0000001337');
...
$products = [
	[
		...
		'slack_message' => '@james @jered @becausealex: KVM Console access was just purchased by %s',
	],
	[
		'enabled' => true,
		...
		'on_purchase' => 'Purchased! Please tell a White Team member to redeem this!',
		'slack_message' => '@james @stefanja: White Team help on inject was just purchased by %s',
	],
	[
		'enabled' => true,
		...
		'on_purchase' => 'Purchased! Please tell a White Team member to redeem this!',
		'slack_message' => '@james @stefanja: White Team help on fixing box was just purchased by %s',
	],
	[
		'enabled' => true,
		...
		'on_purchase' => 'Purchased! Please tell a White Team member to redeem this!',
		'slack_message' => '@james @jered @becausealex: Revert VM was just purchased by %s',
	...
	[
		...
		'on_purchase' => 'Purchased! Please tell a White Team member to redeem this!',
		'slack_message' => '@james @a-a-ron: Red Team advice was just purchased by %s',
	],
	[
		'enabled' => true,
		...
		'on_purchase' => 'Purchased! Please tell a White Team member to redeem this!',
		'slack_message' => '@james @a-a-ron: Red Team immunity was just purchased by %s',
	],
	[
		'enabled' => true,
